...
const tr: ReportMessages = {
  ...
  machineTranslatedNotice:
    "Bu rapor makineyle çevrilmiştir; bağlayıcı metin aşağıdaki İngilizce sürümdür.",
  disclaimer:
...
const es: ReportMessages = {
  ...
  machineTranslatedNotice:
    "Este informe ha sido traducido automáticamente; el texto vinculante es la versión en inglés que figura a continuación.",
  disclaimer:
...
const fr: ReportMessages = {
  ...
  machineTranslatedNotice:
    "Ce rapport a été traduit automatiquement ; le texte faisant foi est la version anglaise ci-dessous.",
  disclaimer:
...
const de: ReportMessages = {
  ...
  machineTranslatedNotice:
    "Dieser Bericht wurde maschinell übersetzt; maßgeblich ist die englische Fassung unten.",
  disclaimer:
...
const ar: ReportMessages = {
  ...
  machineTranslatedNotice:
    "تُرجم هذا التقرير آليًا؛ النص المُلزم هو النسخة الإنجليزية أدناه.",
  disclaimer:
...
const pt: ReportMessages = {
  ...
  machineTranslatedNotice:
    "Este relatório foi traduzido automaticamente; o texto vinculante é a versão em inglês abaixo.",
  disclaimer:
