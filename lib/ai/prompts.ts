...
- If the product contains a battery, search for and state the SPECIFIC chemistry (e.g. "lithium-ion", "lithium-polymer" — not just "rechargeable battery") and its capacity (mAh or Wh) in material_composition if you can find it; if it has wireless connectivity, name the specific technology (e.g. "Bluetooth 5.3", "Wi-Fi", "NFC", "5G cellular" — not just "wireless"). This is downstream of a classification step that asks follow-up questions about exactly these details when they're missing, so finding them now saves the user from being asked later. Still use null/omit anything you genuinely can't confirm — do not guess a chemistry or capacity number.
